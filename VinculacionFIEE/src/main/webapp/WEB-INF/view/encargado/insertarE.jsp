                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-md-12 col-sm-12">
                                <div class="card">
                                    <div class="card-header"><header>Nuevo Encargado</header></div>
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <div class="card-body " id="bar-parent2">
                                                            ...
                                                            <div class="row form-group"><div class="col col-sm-1"></div><div class="col col-sm-2">
                                                                ...
                                                                <form:label path="telefono">Telefono: </form:label></div><div class="col col-sm-8">
                                                            ...
                                                            <div class="row form-group"><div class="col col-sm-1"></div><div class="col col-sm-2">
                                                                ...
                                                                <form:label path="usuario">Usuario:</form:label></div><div class="col col-sm-8">
                                                            ...
                                                            <div class="row form-group"><div class="col col-sm-1"></div><div class="col col-sm-2">
                                                                ...
                                                                <form:label path="pass">Contraseña: </form:label></div><div class="col col-sm-8">
                                                            ...
                                                            <div class="row form-group"><div class="col col-sm-1"></div><div class="col col-sm-2">
                                                                ...
                                                                <form:label path="pass2">Repetir contraseña: </form:label></div><div class="col col-sm-8">
                                                            ...
                                                            <div class="row form-group"><div class="col col-sm-1"></div><div class="col col-sm-2">
                                                                ...
                                                                <form:label path="sexo">Sexo: </form:label></div><div class="col col-sm-8">
