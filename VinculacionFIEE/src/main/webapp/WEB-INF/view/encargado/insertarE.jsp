                                            ...
                                            <div class="white-box">
                                                <div class="p-r1-20">
                                                    <ul class="nav customtab nav-tabs" role="tablist">
                                                        <li class="nav-item"><a href="#tab1" class="nav-link active show" data-toggle="tab"><header>Nuevo Encargado</header></a></li>
                                                    </ul>
                                                </div>
                                                                    ...
                                                                    <!-- text input -->
                                                                        <form:form method="POST" style="font-size:16px;" action="/VinculacionFIEE/encargados/insertar" modelAttribute="nuevo">
                                                                            ...
                                                                            <div class="form-group">
                                                                                    ...
                                                                                    <label path="pass">Contraseña: </label>
                                                                            ...
                                                                            <div class="form-group">
                                                                                    ...
                                                                                    <label path="pass2">Repetir contraseña: </label>
